...
class NYUD_MT(data.Dataset):
    ...
    def __init__(self,
        ...
        if val_seg == 'PASCALContext':
            ...
            self.do_task = True
        # self.to_voc = [31, 6, 5, 7]
        # self.to_task = [24, 7, 33, 6, 4, 34, 5]
        self.to_voc = [30, 5, 4, 6]
        self.to_task = [23, 6, 32, 5, 3, 33, 4]
        
        # if self.do_semseg:
        #     non_valid_seg = []
        #     for i in range(len(self.images)):
        #         sample = {}
        #         _img = self._load_img(i)
        #         sample['image'] = _img
        #         _semseg = self._load_semseg(i)
        ...
        #         _semseg = self.filter_semseg(_semseg)
        #         if np.mean(_semseg) == 255: non_valid_seg.append(i)
            
        #     for ele in sorted(non_valid_seg, reverse = True):
        #         del self.images[ele]
        #         del self.im_ids
        ...
        #         del self.edges[ele]
        #         # Semantic Segmentation
        #         del self.semsegs[ele]
        #         # Surface Normals
        #         del self.normals[ele]
        #         # Depth Prediction
        #         del self.depths[ele]
    ...
    def filter_semseg(self, _semseg):
        ...
        if self.do_voc:
            ...
            mask = np.isin(_semseg, self.to_task)
            _semseg[~mask] = 255            
            for new_idx, idx in enumerate(self.to_task):
                _semseg[_semseg_ref==idx] = new_idx
        else:
            pass
        return _semseg
